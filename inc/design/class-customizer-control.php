 ...
 * @access public
 */
class CxTh_Customizer_Control extends WP_Customize_Control {
	 ...
	 * @uses CxTh_Customizer_Control::render_head(), CxTh_Customizer_Control::render_inputs()
	 * @since  1.0.0
	 * @access public
	 * @return void
	 */
	 ...
	 * @uses CxTh_Customizer_Control::render_multi_inputs()
	 * @since  1.0.0
	 * @access protected
	 * @return void
	 */
	protected function render_inputs() {
		?>
		<div class="<?php echo 'cxth-custom-control button-control cxth-' . $this->type; ?>">
			<?php
